    ...
    pt-2 pb-5'>
      <div className='section-container grid grid-cols-1 sm:grid-col-2 md:grid-cols-5 gap-8 px-8'>
        ...
        <div className='md:col-span-2'>
          <h2 className='font-bold text-2xl'><Link to="/">Furniture</Link></h2>
          <p className='md:mr-12 mt-4'>The advantage of hiring a workspace with us is that givees you comfortable service and all-around facilities.</p>
        </div>
        {/* services div */}
        <div>
        ...
        <div>
          ...
          <ul className='space-y-2'>
            <li>
              <Link to="/" className='hover:text-primary transition ease-in-out duration-200'>Beds</Link>
            </li>
            <li>
              <Link to="/" className='hover:text-primary transition ease-in-out duration-200'>Chair</Link>
            </li>
            <li>
              <Link to="/" className='hover:text-primary transition ease-in-out duration-200'>All</Link>
            </li>
          </ul>
        </div>
        {/* Follow Us div */}
